...
jQuery.sap.require('sap.apf.ui.representations.combinationChart');
jQuery.sap.require('sap.apf.ui.representations.stackedCombinationChart');
jQuery.sap.require('sap.apf.ui.representations.dualCombinationChart');
jQuery.sap.require('sap.apf.ui.representations.dualStackedCombinationChart');
				...
				deferredMode.done(function(mode) {
					...
					promiseStartFilters.done(function(aConfiguredFilters) { //visible filters are returned in the callback
						...
						if (mode.navigationMode === "backward") {
							that.getAnalysisPath().getController().isBackNavigation = true; //Boolean to set busy indicator to false-FIXME
