...
sap.ui.define([
	"sap/ui/core/Element", "sap/gantt/misc/Utility", "sap/gantt/misc/Format", "sap/gantt/misc/RelativeTimeFormatter", "sap/gantt/config/TimeHorizon", "sap/ui/core/Locale", "sap/gantt/misc/AxisTime"
], function (Element, Utility, Format, RelativeTimeFormatter, TimeHorizon, Locale, AxisTime) {
	"use strict";
	...
	AxisTimeStrategyBase.prototype.applySettings = function (mSettings) {
		...
		if (!mSettings.visibleHorizon) {
			mSettings.visibleHorizon = sap.gantt.config.DEFAULT_INIT_HORIZON.clone();
		}
		if (!mSettings.totalHorizon) {
			mSettings.totalHorizon = sap.gantt.config.DEFAULT_PLAN_HORIZON.clone();
		}
