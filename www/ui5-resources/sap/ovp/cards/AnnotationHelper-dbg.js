...
sap.ui.define(["jquery.sap.global", "sap/ui/core/format/NumberFormat", "sap/ui/core/format/DateFormat",
        ...
        "sap/ui/core/ValueState", "sap/ui/model/FilterOperator", "sap/ui/Device",
        "sap/ui/model/analytics/odata4analytics", "sap/ui/vbm/library", "sap/ui/generic/app/navigation/service/SelectionVariant"],
    function (jQuery, NumberFormat, DateFormat, CommonUtils, OdataAnnotationHelper, ValueState,
              FilterOperator, Device, odata4analytics, VbmLibrary, SelectionVariant) {
            ...
            * */
            ...
            if (value !== undefined) {
                ...
                if (endsWith(sImproveDirection, "Minimize") || endsWith(sImproveDirection, "Minimizing")) {
                    ...
                    if (toleranceHigh && deviationHigh && toleranceLow && deviationLow ) {
            ...
            if (!bIncludeOnlyUOM) {
                ...
                if (oEntityTypeProperty["type"] === 'Edm.DateTime' || oEntityTypeProperty["type"] === 'Edm.DateTimeOffset') {
                    ...
                    if (bUseSimplePath) {
                        ...
                        result = OdataAnnotationHelper.format(iContext, oItem.Value);
                    }
                }

                //Get text arrangement (if present) binding for the property
                //Text Arrangement to be applied only for table card and list card
                if (sContentFragment && (sContentFragment === "sap.ovp.cards.table.Table" || sContentFragment === "sap.ovp.cards.list.List")) {
        ...
        function getNumberFormatFunctionName(numberOfFractionalDigits) {
            ...
            if (!NumberFormatFunctions[functionName]) {
                NumberFormatFunctions[functionName] = generateNumberFormatFunc(Number(numberOfFractionalDigits));
            }
        ...
        function getCurrencyFormatFunctionName(iNumberOfFractionalDigits, sCurrency) {
            ...
            if (!CurrencyFormatFunctions[functionName]) {
                CurrencyFormatFunctions[functionName] = generateCurrencyFormatFunc(iNumberOfFractionalDigits, sCurrency);
            }
