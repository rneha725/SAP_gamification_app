sap.ui.define(["sap/ui/core/mvc/Controller", "sap/ovp/cards/ActionUtils",
        ...
        "sap/ovp/cards/loading/State", "sap/ui/generic/app/library", "jquery.sap.global"],
    ...
    function (Controller, ActionUtils, SelectionVariant, PresentationVariant,
              ...
              JSONModel, Dialog, Button, MessageToast, TextDirection, LoadingState, GenericAppLibrary, jQuery) {
        "use strict";
        return Controller.extend("sap.ovp.cards.generic.Card", {
            ...
            fnHandleError: function (oError) {
                if (oError instanceof NavError) {
                    if (oError.getErrorCode() === "NavigationHandler.isIntentSupported.notSupported") {
                        MessageBox.show(sap.ui.getCore().getLibraryResourceBundle("sap.ovp").getText("OVP_NAV_ERROR_NOT_AUTHORIZED_DESC"), {
            ...
            doIntentBasedNavigation: function (oContext, oIntent, oUrlWithIntent) {
                ...
                if (oNavigationHandler) {
                    if (oIntent) {
                        ...
                        var oAppInnerData = null;
                        //Create inner data only if presentation variant is present
                        if (oParameters.sNavPresentationVariant) {
                            oAppInnerData = this.oMainComponent && this.oMainComponent._getCurrentAppState();
                            // In the case of global filter not being present, oAppInnerData will be null
                            if (oAppInnerData) {
                                oAppInnerData.presentationVariant = oParameters.sNavPresentationVariant;
                            }
                        }
            ...
            _getEntityNavigationParameters: function (oEntity, oCustomParameters) {
                ...
                var oSelectionVariant, oPresentationVariant;
            ...
            _callFunction: function (mUrlParameters, actionText) {
                ...
                oPromise.then(function (oResponse) {
                    return MessageToast.show(sap.ui.getCore().getLibraryResourceBundle("sap.ovp").getText("Toast_Action_Success"), {
                        duration: 1000
                    });
                }, function (oError) {
