sap.ui.define(["sap/ovp/cards/generic/Card.controller", "jquery.sap.global",
        ...
        "sap/ui/core/ResizeHandler", "sap/m/MessageToast", "sap/m/Image"],

    function (CardController, jQuery, OVPCardAsAPIUtils, CommonUtils, List, ResizeHandler, MessageToast, Image) {
        "use strict";
        /*global sap, jQuery */
        ...
        return CardController.extend("sap.ovp.cards.linklist.LinkList", {
            ...
            onFuImpSuccess: function (oEvent) {
                MessageToast.show(sap.ui.getCore().getLibraryResourceBundle("sap.ovp").getText("Toast_Action_Success"), {
                    duration: 3000
                });
            },

            onFuImpFailed: function (oResponse) {
                MessageToast.show(sap.ui.getCore().getLibraryResourceBundle("sap.ovp").getText("Toast_Action_Error"), {
                    duration: 3000
                });
            },
