sap.ui.define([
	...
	var CalculationBuilderFunction = Control.extend("sap.suite.ui.commons.CalculationBuilderFunction", {
		metadata: {
			...
			properties: {
				/**
				 * A key associated with the function. This propery is mandatory.<br>
			...
			aggregations: {
				 ...
				 * For example, if the function has two parameters, the <code>items</code> aggregation may include:
				 * <ul>
				 * <li>A {@link sap.suite.ui.commons.CalculationBuilderItem} with an empty key for the first argument
				 * entered by the user.</li>
				 * <li>A {@link sap.suite.ui.commons.CalculationBuilderItem} with a <code>,</code> key for the comma
