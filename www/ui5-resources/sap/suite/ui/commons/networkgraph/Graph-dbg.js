sap.ui.define([
	...
	Graph.prototype.init = function () {
		...
		// non computed (!) element width which is used for storing width when setting full screen
		// full screen needs current with to be 100%
		this._iStoredWidth = "";
	...
	Graph.prototype._toggleFullScreen = function (oEvent) {
		var fnIsDefaultWidth = function () {
			return this._iStoredWidth === "100%";
		}.bind(this);
		...
		var fnOpen = function () {
			...
			if (this._oFullScreenContainer.$content) {
				this._iStoredWidth = this.getDomRef().style.width;
	...
	Graph.prototype._createLegend = function () {
		...
		var fnAddElement = function (oElement, oItemStatuses) {
			var sStatus = jQuery.sap.encodeHTML(oElement.getStatus());
			if (sStatus) {
