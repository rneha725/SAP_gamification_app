sap.ui.define([
	...
	"sap/ui/Device", "sap/ui/model/SimpleType", "sap/ui/core/library", "sap/m/library"
		...
		DropDownController, FilterItemMicroBar, FilterItemMicroLine, FilterItemMicroDonut, JSONModel,
		CustomData, Text, OverflowToolbarLayoutData, FilterOperator, Device, SimpleType, SapCoreLibrary, SapMLibrary) {
	"use strict";
					...
					for (var i = 0; i < selectOptions.length; i++) {
						...
						if (mappedSelectionVariant.indexOf(sProperty) === -1) {
							...
							if (sProperty === parentProperty) {
								...
								//if there is a value from SV and from SFB for the same property, consider the SFB one, skip SV
