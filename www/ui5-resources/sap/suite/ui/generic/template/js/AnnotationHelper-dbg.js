		...
		*/
		...
		createP13NColumnForAction: function (iContext, oDataField) {
			...
			if (oDataField && oDataField.Value && oDataField.Value.Path) {
				var sP13N = '\\{"columnKey":"' + sColumnKey + '", "sortProperty":"' + oDataField.Value.Path + '", "leadingProperty":"' + oDataField.Value.Path + '", "filterProperty":"' + oDataField.Value.Path + '", "columnIndex":"' + iColumnIndex + '", "actionButton":"true" \\}';
			} else {
			...
			if (oDataFieldTarget && oDataFieldTarget.fn && oDataFieldTarget.fn.Path) {
				if (sNavigation) {
					...
					sP13N = '\\{"columnKey":"' + sColumnKey +
						...
						'", "sortProperty":"' + sNavigation + '/' + oDataFieldTarget.fn.Path +
						'", "filterProperty":"' + sNavigation + '/' + oDataFieldTarget.fn.Path +
						'", "additionalProperty":"' + sNavigation;
				} else {
					sP13N = '\\{"columnKey":"' + sColumnKey +
						'", "leadingProperty":"' + oDataFieldTarget.fn.Path +
						'", "sortProperty":"' + oDataFieldTarget.fn.Path +
