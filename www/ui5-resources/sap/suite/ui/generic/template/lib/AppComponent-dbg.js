			...
			var oNewRetemplatingPromise = new Promise(function(fnResolve){
				...
				oRetemplatingPromise.then(function(){
					...
					oTemplateContract.oNavigationControllerProxy.getActiveComponents().forEach(function(sComponent){
						var oComponentRegistryEntry = oTemplateContract.componentRegistry[sComponent]; 
						var oOldContainer = oComponentRegistryEntry.oComponent.getComponentContainer();
						...
						var oNewContainer = oTemplateContract.oNavigationControllerProxy.createComponentInstance(
								oTemplateContract, oComponentRegistryEntry.routeConfig,
								oTemplateContract.oNavigationControllerProxy.mRouteToComponentResolve[oComponentRegistryEntry.route]);
						...
						aComponentRetemplatingPromises.push( 
								oNewContainer.loaded().then(function(oNewContainer){
									...
									oTemplateContract.componentRegistry[oNewComponent.sId].activationTakt = oComponentRegistryEntry.activationTakt;
									oTemplateContract.mRouteToTemplateComponentPromise[oComponentRegistryEntry.route] = Promise.resolve(oNewComponent);
									/*
									 ...
									 */
									return oTemplateContract.componentRegistry[oNewComponent.sId].oViewRenderedPromise; 
								})
						);
					});
