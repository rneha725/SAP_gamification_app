...
sap.ui.define([
	...
	function constructor(oNavigationController, oTemplateContract){
		...
		oNavigationControllerProxy.oRouter._oViews._getViewWithGlobalId = function(oView) {
			 ...
			 * 
			 * In older versions, a special map (mViews) was used here - but as all necessary information is 
			 * available in componentRegistry, we should avoid to duplicate it
			 */
