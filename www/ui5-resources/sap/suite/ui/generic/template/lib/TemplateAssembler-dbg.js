...
sap.ui
	.define(["jquery.sap.global", "sap/ui/core/mvc/ControllerExtension", "sap/ui/core/mvc/View", 
		...
		function(jQuery, ControllerExtension, View, JSONModel, ResourceModel, TemplateViewController, TemplateComponent, Application, CRUDManager, CommonUtils,
			...
			//   As a general rule an extension project should access the generic services available for him in the same way it is done by the implementation of a break-out.
			...
			return {
				...
				getTemplateComponent: function(getMethods, sComponentName, oComponentDefinition) {
					...
					oComponentDefinition.init = function() {
						...
						oComponentRegistryEntry.oTemplateContract.oBusyHelper.setBusy(oComponentRegistryEntry.viewRegisterd, true);
