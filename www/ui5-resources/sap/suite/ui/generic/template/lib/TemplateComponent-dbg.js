sap.ui.define(["jquery.sap.global", "sap/ui/core/CustomizingConfiguration", "sap/ui/core/mvc/ViewType", "sap/ui/core/Component", "sap/ui/core/UIComponent", "sap/ui/model/json/JSONModel", "sap/ui/model/resource/ResourceModel", "sap/ui/Device", "sap/suite/ui/generic/template/lib/reuseComponentHelper"],
	function(jQuery, CustomizingConfiguration, ViewType, Component, UIComponent, JSONModel, ResourceModel, Device, reuseComponentHelper) {
		"use strict";
			...
			oComponentRegistryEntry.reuseComponentsReady = new Promise(function(fnResolve, fnReject){
				...
				if (oComponentRegistryEntry.viewLevel > 0){ // The root component does not contain any embedded components
					...
					if (oTreeNode){
						...
						oComponentRegistryEntry.viewRegisterd.then(function(){
