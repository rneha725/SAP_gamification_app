...
// Provides Controller
sap.ui.define([
	'jquery.sap.global', 'sap/ui/base/ManagedObject', 'sap/m/library', 'sap/ui/comp/library', './ColumnsController', './FilterController', './GroupController', './SortController', './DimeasureController', './SelectionController', './Util', './ChartWrapper', './SelectionWrapper', './ColumnHelper', 'sap/ui/core/MessageType', 'sap/m/P13nDialog', './Validator', 'sap/ui/model/json/JSONModel', 'sap/ui/Device', 'sap/ui/model/BindingMode'
], function(jQuery, ManagedObject, MLibrary, CompLibrary, ColumnsController, FilterController, GroupController, SortController, DimeasureController, SelectionController, Util, ChartWrapper, SelectionWrapper, ColumnHelper, MessageType, P13nDialog, Validator, JSONModel, Device, BindingMode) {
	"use strict";
		...
		this._oDialog = new P13nDialog(this.getId() + "-P13nDialog", {
			...
			validationExecutor: function() {
				...
				return Validator.checkGroupAndColumns(sTableType, oSettingForOpen, oColumnKey2ColumnMap, oControlDataReduceTotal, []).then(function(aResultTotal) {
					return Validator.checkSaveChanges(sTableType, oSettingForOpen, oControlDataReduceTotal, aResultTotal);
