...
sap.ui.define([
	'jquery.sap.global', './BaseController', 'sap/m/library', 'sap/ui/comp/library', 'sap/ui/table/library', './Util', 'sap/m/P13nConditionPanel'
], function(jQuery, BaseController, MLibrary, CompLibrary, TableLibrary, Util, P13nConditionPanel /*Needed for Enum sap.m.P13nConditionOperation */) {
	"use strict";
	...
	GroupController.prototype.getColumn2Json = function(oColumn, sColumnKey, iIndex) {
		...
		return {
			...
			operation: oColumn.getSortOrder && oColumn.getSortOrder() === TableLibrary.SortOrder.Ascending ? sap.m.P13nConditionOperation.GroupAscending : sap.m.P13nConditionOperation.GroupDescending,
		...
		return new Promise(function(resolve) {
			...
			sap.ui.require([
				...
				return resolve(new P13nGroupPanel({
					maxGroups: that.getTableType() === CompLibrary.personalization.TableType.AnalyticalTable ? "-1" : "1",
					containerQuery: true,
					items: {
