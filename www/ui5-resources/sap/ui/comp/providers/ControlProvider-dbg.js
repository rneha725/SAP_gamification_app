...
], function(jQuery, CheckBox, ComboBox, DatePicker, TimePicker, HBox, Input, Text, ObjectIdentifier, ObjectStatus, Image, Link, VBox, SmartLink, MetadataAnalyser, ODataHelper, SmartField, ODataType, CriticalityMetadata, FormatUtil, MultiCurrencyUtil, Control, SemanticObjectController, NavigationPopoverHandler) {
	"use strict";
