...
sap.ui.define([
	'jquery.sap.global', 'sap/ui/comp/library', 'sap/m/VBox', 'sap/m/VBoxRenderer', 'sap/m/FlexItemData', 'sap/m/List', 'sap/m/Tree', 'sap/m/Title', 'sap/m/Toolbar', 'sap/m/OverflowToolbar', 'sap/m/ToolbarDesign', 'sap/m/ToolbarSpacer', 'sap/m/OverflowToolbarButton', 'sap/ui/comp/odata/ODataModelUtil', 'sap/ui/comp/util/FullScreenUtil', 'sap/ui/core/format/NumberFormat'
], function(jQuery, library, VBox, VBoxRenderer, FlexItemData, List, Tree, Title, Toolbar, OverflowToolbar, ToolbarDesign, ToolbarSpacer, OverflowToolbarButton, ODataModelUtil, FullScreenUtil, NumberFormat) {
	"use strict";
	...
	SmartList.prototype._toggleFullScreen = function(bValue, bForced) {
		...
		FullScreenUtil.toggleFullScreen(this, this.bFullScreen, this._oFullScreenButton);
