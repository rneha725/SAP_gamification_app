...
sap.ui.define([
	...
	SmartTable.prototype._toggleFullScreen = function(bValue, bForced) {
		...
		FullScreenUtil.toggleFullScreen(this, this.bFullScreen, this._oFullScreenButton, this._toggleFullScreen.bind(this, false));
	...
	SmartTable.prototype._triggerUI5ClientExport = function() {
		...
		oExportLibLoadPromise.then(function() {
			var aColumns = this._oTable.getColumns(), i, iLen = aColumns.length, oColumn, oColumnData, oLabel, sPath, sTemplate, nWidth, sType, inputFormat, oType, aSheetColumns = [];
