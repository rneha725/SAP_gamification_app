...
sap.ui.define([
	'jquery.sap.global', 'sap/ui/comp/library', './PersonalizableInfo', './SmartVariantManagementAdapter', 'sap/ui/comp/variants/VariantItem', 'sap/ui/comp/variants/VariantManagement', 'sap/ui/comp/odata/MetadataAnalyser', 'sap/ui/fl/registry/Settings', 'sap/ui/fl/Change', 'sap/ui/fl/Persistence', 'sap/ui/fl/Utils', 'sap/ui/fl/transport/TransportSelection'
], function(jQuery, library, PersonalizableInfo, SmartVariantManagementAdapter, VariantItem, VariantManagement, MetadataAnalyser, Settings, Change, Persistence, FlexUtils, TransportSelection) {
	"use strict";
		...
		try {
			...
			if (this._oControlPromise && this._oPersoControl && oCurrentControlWrapper) {
				...
				Promise.all([
					...
					that._dataReceived(aVariants[1], aVariants[2], oCurrentControlWrapper);
