...
// }
	...
	VariantManagement.prototype._getTransportSelection = function() {
		if (this.getTransportSelection) {
			return Promise.resolve(this.getTransportSelection());
		} else {
	...
	VariantManagement.prototype._getFlTransportSelection = function() {
		...
		var fTransportSelection = sap.ui.require("sap/ui/fl/transport/TransportSelection");
		if (fTransportSelection) {
			return Promise.resolve(new fTransportSelection());
		} else {
