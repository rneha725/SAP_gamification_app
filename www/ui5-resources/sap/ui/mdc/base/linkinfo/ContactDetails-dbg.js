...
sap.ui.define([
	'jquery.sap.global', 'sap/ui/core/XMLComposite', 'sap/m/Text', 'sap/m/Link', 'sap/m/Label'
], function(jQuery, XMLComposite, Text, Link, Label) {
	"use strict";
	 ...
	 * @private
	 * @since 1.56.0
	 * @alias sap.ui.mdc.base.linkinfo.ContactDetails
	 * @ui5-metamodel This control/element also will be described in the UI5 (legacy) designtime metamodel
	 */
	var ContactDetails = XMLComposite.extend("sap.ui.mdc.base.linkinfo.ContactDetails", /** @lends sap.ui.mdc.base.linkinfo.ContactDetails.prototype */
		{
			metadata: {
				library: "sap.ui.mdc",
				aggregations: {
	...
	ContactDetails.prototype.applySettings = function() {
		...
		var oVBox = this.getAggregation("_content");
	...
	ContactDetails.prototype._addEmailsToSimpleForm = function(oContactDetailsItem, oSimpleForm, oRB) {
		...
		oContactDetailsItem.getEmails().filter(function(oContactDetailsLinkItem) {
			...
			this._addLabeledLink("email", oRB.getText("linkinfo.POPOVER_CONTACT_SECTION_EMAIL"), oContactDetailsLinkItem, oSimpleForm);
	...
	ContactDetails.prototype._addPhonesToSimpleForm = function(oContactDetailsItem, oSimpleForm, oRB) {
		...
		oContactDetailsItem.getPhones().filter(function(oContactDetailsLinkItem) {
			...
			this._addLabeledLink("phone", oRB.getText("linkinfo.POPOVER_CONTACT_SECTION_PHONE"), oContactDetailsLinkItem, oSimpleForm);
			oContactDetailsLinkItem.processed = true;
		}, this);
		...
		oContactDetailsItem.getPhones().filter(function(oContactDetailsLinkItem) {
			...
			this._addLabeledLink("phone", oRB.getText("linkinfo.POPOVER_CONTACT_SECTION_MOBILE"), oContactDetailsLinkItem, oSimpleForm);
			oContactDetailsLinkItem.processed = true;
		}, this);
		...
		oContactDetailsItem.getPhones().filter(function(oContactDetailsLinkItem) {
			...
			this._addLabeledLink("phone", oRB.getText("linkinfo.POPOVER_CONTACT_SECTION_FAX"), oContactDetailsLinkItem, oSimpleForm);
			oContactDetailsLinkItem.processed = true;
		}, this);
	...
	ContactDetails.prototype._addLabeledAddress = function(oContactDetailsAddressItem, oSimpleForm, oRB) {
		...
		var oLabel = new Label({
			text: oRB.getText("linkinfo.POPOVER_CONTACT_SECTION_ADR"),
