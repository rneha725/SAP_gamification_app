...
sap.ui.define(['jquery.sap.global', 'sap/ui/core/Control', 'sap/ui/core/ResizeHandler', './library', './ToolbarWrapper', "sap/ui/core/RenderManager"],
	function(jQuery, Control, ResizeHandler, library, ToolbarWrapper, RenderManager) {
	"use strict";
	/**
	...
	RichTextEditor.prototype.initTinyMCE = function() {
		RenderManager.attachPreserveContent(this._tinyMCEPreserveHandler, this);
	...
	RichTextEditor.prototype._tinyMCEPreserveHandler = function(oData) {
	...
	RichTextEditor.prototype.unloadTinyMCE = function() {
		...
		RenderManager.detachPreserveContent(this._tinyMCEPreserveHandler);
