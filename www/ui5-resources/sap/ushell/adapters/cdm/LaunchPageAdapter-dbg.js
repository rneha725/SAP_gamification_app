...
sap.ui.define([
    ...
    "sap/ushell/EventHub",
    "sap/ushell/Config"
], function ( GenericTile, oGenericTileMode, oResources, oUtilsCdm, oUshellUtils, navigationMode, oEventHub, Config) {
    "use strict";
        ...
        this.moveGroup = function (oGroup, nNewIndex) {
            ...
            oCdmSiteService.getSite()
                .done(function (oSite) {
                    ...
                    aGroupsOrderAfterMove = oUshellUtils
