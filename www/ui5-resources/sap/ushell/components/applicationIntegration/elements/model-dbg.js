...
sap.ui.define(function () {
    ...
    function ElementsModel () {
        ...
        this.createDefault = function () {
            ...
            var fnAddBackButtonOnFirstNavigation = function () {
                hashChangeCount++;
        ...
        this.init = function (oConfig){
            ...
            //DO IN FUTURE: make better initialization i.e. make sure that oCustomShellStateModel variable is initialized
        ...
        this.switchState = function (sState, bSaveLastState) {
            var sPath = sState[0] === "/" ? sState : "/states/" + sState,
                ...
                excludeStatesInGC = ["home", "embedded-home", "headerless-home", "merged-home", "blank-home", "lean-home"];
