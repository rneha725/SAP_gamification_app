...
sap.ui.define(['sap/ushell/components/flp/launchpad/DashboardManager', 'sap/ushell/resources', 'sap/ui/core/UIComponent', 'sap/ushell/components/flp/ComponentKeysHandler', 'sap/ushell/components/flp/CustomRouter', 'sap/ushell/UserActivityLog', 'sap/ushell/Config'], function (DashboardManager, resources, UIComponent, ComponentKeysHandler, CustomRouter, UserActivityLog, Config) {
    ...
    return UIComponent.extend("sap.ushell.components.flp.Component", {
        ...
        createContent: function () {
            ...
            sap.ui.getCore().getEventBus().subscribe("shell", "changeNotificationPreview", this._updateNotificationPreview, this);
            ...
            this.oShellNavigation.registerNavigationFilter(this.handleNavigationFilter.bind(this));
        ...
        _updateNotificationPreview: function (sChannelId, sEventId, oData) {
            ...
            this.oModel.setProperty("/userEnableNotificationsPreview", oPreviewFlags.bUserEnableNotificationsPreview);
            this.oModel.setProperty("/configEnableNotificationsPreview", oPreviewFlags.bConfigEnableNotificationsPreview);
            if (oPreviewFlags.bMainFlagExists === true) {
                this.oModel.setProperty("/enableNotificationsPreview", oPreviewFlags.bEnableNotificationsPreview);
            }
        },
        ...
        exit : function () {
            sap.ui.getCore().getEventBus().unsubscribe("shell", "changeNotificationPreview", this._updateNotificationPreview, this);
...
sap.ui.define(['sap/ushell/services/Message', 'sap/ui/base/EventProvider', 'sap/ushell/ui/launchpad/TileState', 'sap/ushell/components/flp/launchpad/PagingManager', 'sap/ushell/components/flp/launchpad/DashboardLoadingManager', 'sap/ushell/EventHub'],
	function (Message, EventProvider, TileState, PagingManager, DashboardLoadingManager, oEventHub) {
	"use strict";
    ...
    var DashboardManager = EventProvider.extend("sap.ushell.components.flp.launchpad.DashboardManager", {
        ...
        */
        ...
        /**
         * Manage that all tiles and links from segments will be binded to the group model.
         ...
         * When all segments are handled, dashboard model finished loading event is publiched.
         */
        _handleSegment: function () {
            var oConfigurationSegments = this.oModel.getProperty("/segments") || {},
                iInterval = this.bIsFirstSegment ? oConfigurationSegments.firstInterval || 200 : oConfigurationSegments.interval || 100,
                aUpdatedGroupModel;
        ...
        loadGroupsFromArray: function (aGroups) {
            ...
            this.oPageBuilderService.getDefaultGroup().done(function (oDefaultGroup) {
                ...
                aPreparedGroupModel = that._processSegment(groupModel);
                ...
                for (var i = 0; i < groupModel.length; i++) {
                    if (groupModel[i].isGroupVisible && groupModel[i].visibilityModes[0]) {
                        aPreparedGroupModel[i]["isGroupSelected"] = true;
                ...
                aPreparedGroupModel["length"] = groupModel.length;
                ...
                oEventHub.once("firstSegmentCompleteLoaded").do(that._handleSegment.bind(that));
...
sap.ui.define(["jquery.sap.global",'./DashboardUIActions', 'sap/ushell/utils'],
    function ($, DashboardUIActions, utils) {
	"use strict";
 ...
 * @private
 */
sap.ui.define (["sap/ushell/Layout", "sap/ui/base/Object", "sap/ushell/ui/launchpad/DashboardGroupsContainer"], function (Layout, baseObject, DashboardGroupsContainer) {
	"use strict";
    ...
    var DashboardGroupsBox = baseObject.extend("sap.ushell.components.flp.launchpad.dashboard.DashboardGroupsBox", {
        ...
        _updateFirstGroupHeaderVisibility: function (bIsEditMode, bEnableAnchorBar) {
            ...
            if (iFirstVisible !== undefined) {
                ...
                var oFirstGroupDomRef = aGroups[iFirstVisible].getDomRef();
                oFirstGroupDomRef.getElementsByClassName("sapUshellTileContainerHeader")[0].classList.add("sapUiPseudoInvisibleText");
                aGroups[iFirstVisible].setShowGroupHeader(bIsEditMode || (iVisibleGroups == 1 && bEnableAnchorBar), bFirstGroup);
            }
        },
...
sap.ui.define(['sap/ushell/ui/launchpad/GroupListItem', 'sap/ushell/override'],
    function (GroupListItem, override) {
	"use strict";
