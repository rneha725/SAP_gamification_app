...
sap.ui.define(['sap/ushell/components/tiles/utils', 'sap/ushell/components/tiles/utilsRT','sap/ushell/components/applicationIntegration/AppLifeCycle'],
    function (utils, utilsRT,AppLifeCycle) {
	"use strict";
