sap.ui.require.preload({
	"sap/ushell/plugins/appwarmup/Component.js":function(){sap.ui.define(["jquery.sap.global", "sap/ui/core/Component", "sap/ui/core/mvc/Controller", "sap/ui/core/service/ServiceFactory", "sap/ui/core/service/ServiceFactoryRegistry", "./ShellUIService"], function (jQuery, Component, Controller, ServiceFactory, ServiceFactoryRegistry, ShellUIService) {
    "use strict";
    ...
    return Component.extend(sComponentName, {
        ...
        init: function () {
            ...
            // only do the warmup if the user has opened the shell home
            var currentApplication = sap.ushell.Container.getService("AppLifeCycle").getCurrentApplication();

            if (currentApplication.homePage) {
                this.doWarmUp();
            }
