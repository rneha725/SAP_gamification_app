...
sap.ui.define(['sap/ui/core/UIComponent','./RendererExtensions','sap/ushell/ui/shell/ToolAreaItem', './FlpMeasure'],
    function (UIComponent, RendererExtensions, ToolAreaItem, flpmeasure) {
        "use strict";
    ...
    Renderer.prototype.createContent = function () {
        ...
        // required for the CoPilot screen shot functionality;
        // set the property directly because the core validation does not accept CSS "vh" units:
        oView.mProperties.height = "100vh";
        ...
        this.oAppsLifeCycle = sap.ushell.components.applicationIntegration.AppLifeCycle;
        this.oShellModel = this.oAppsLifeCycle.getElementsModel();

        return oView;
    };

    /*------------------------------------------Override UIComponent------------------------------*/
    /* The view is placed directly on the page and is removed from the rootControl aggreagation.  */
    /* See sap.ui.core.Control.placeAt. Override sap.ui.core.UIComponent to return correct values */
    Renderer.prototype.getRootControl = function () {
        return this._oShellView;
    };

    Renderer.prototype.getUIArea = function () {
        return this._oShellView && this._oShellView.getUIArea();
    };
