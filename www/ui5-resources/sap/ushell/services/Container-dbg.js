...
sap.ui.define([
    ...
    'sap/ui/core/Control'
], function (utils, System, oUi5ServiceFactory, ServiceFactoryRegistry, Control) {
    "use strict";
        ...
        this.createRenderer = function (sRendererName, bAsync) {
            ...
            function getRendererInstance() {
                ...
                if (sComponentName === "sap.ushell.renderers.fiori2.Renderer") {
                    // Do not create a ComponentController for fiori2
                    // Place the Shell.view into the UI Area directly
                    oShellControl = oRenderer.getRootControl();
                }
                ...
                if (!(oShellControl instanceof sap.ui.core.Control)) {
