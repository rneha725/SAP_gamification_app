...
sap.ui.define(['sap/m/Button', 'sap/m/Dialog', 'sap/m/Bar', 'sap/m/Text', 'sap/m/List', 'sap/ushell/library', 'sap/ushell/resources', 'sap/ushell/ui/launchpad/AccessibilityCustomData', 'sap/ushell/ui/launchpad/ActionItem', 'sap/m/DisplayListItem', 'sap/ui/layout/VerticalLayout', 'sap/m/ObjectIdentifier', './UserPreferencesButtonRenderer'], function (Button, Dialog, Bar, Text, List, library, resources, AccessibilityCustomData, ActionItem, DisplayListItem, VerticalLayout, ObjectIdentifier/*, UserPreferencesButtonRenderer */) {
    "use strict";
