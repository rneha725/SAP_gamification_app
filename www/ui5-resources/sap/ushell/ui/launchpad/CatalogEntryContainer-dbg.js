...
sap.ui.define([
    ...
    CatalogEntryContainer.prototype.handleElements = function (sReason) {
        ...
        indexSearchMissingFilteredElem = TileContainerUtils.markVisibleOnScreenElements(aBindingContexts, this.indexingMaps[sName], true);
        ...
        if (TileContainerUtils.createMissingElementsInOnScreenElements(this.indexingMaps[sName], aBindingContexts, indexSearchMissingFilteredElem, this.addNewItem.bind(this), aItems ,this.filters[sName], sName)) {
