...
sap.ui.define(['sap/ui/base/ManagedObject', 'sap/ui/core/Control', 'sap/ushell/library', 'sap/ushell/override', 'sap/ushell/utils', './DashboardGroupsContainerRenderer'],
	function(ManagedObject, Control, library, override, utils/*, DashboardGroupsContainerRenderer */) {
	"use strict";
...
/*global jQuery, sap*/
    ...
    DashboardGroupsContainer.prototype.onAfterRendering = function () {
        ...
        if (this.onAfterRenderingTimer ) {
            utils.setPerformanceMark("FLP-TimeToInteractive_tilesLoaded", true);
