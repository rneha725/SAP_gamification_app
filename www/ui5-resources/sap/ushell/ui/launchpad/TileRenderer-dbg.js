...
sap.ui.define(['jquery.sap.global', 'sap/ushell/components/applicationIntegration/AppLifeCycle'],
    function (jQuery, AppLifeCycle) {
	"use strict";
    ...
    TileRenderer.render = function (oRm, oControl) {
        ...
        if (oShellModel && oShellModel.getModel()){
            if (oShellModel.getModel().getProperty("/sizeBehavior")){
              if (oShellModel.getModel().getProperty("/sizeBehavior") == "Small") {
